...
public class WorldGenCaves extends WorldGenBase {
	...
	protected void a(long i, int j, int k, Block[] ablock, double d0, double d1, double d2, float f, float f1, float f2,
			int l, int i1, double d3) {
		...
		for (boolean flag1 = random.nextInt(6) == 0; l < i1; ++l) {
			...
			if (!flag && l == k1 && f > 1.0F && i1 > 0) {
				this.a(random.nextLong(), j, k, ablock, d0, d1, d2, random.nextFloat() * 0.5F + 0.5F, f1 - 1.5707964F,
						f2 / 3.0F, l, i1, 1.0D);
				this.a(random.nextLong(), j, k, ablock, d0, d1, d2, random.nextFloat() * 0.5F + 0.5F, f1 + 1.5707964F,
						f2 / 3.0F, l, i1, 1.0D);
				return;
						...
						for (int l3 = l2; !flag2 && l3 < i3; ++l3) {
							for (int i4 = k2 + 1; !flag2 && i4 >= j2 - 1; --i4) {
								...
								if (i4 >= 0 && i4 < 256) {
									...
									if (block == Blocks.WATER || block == Blocks.WATER) {
										flag2 = true;
									}
								...
								if (d12 * d12 + d13 * d13 < 1.0D) {
									for (int k4 = k2 - 1; k4 >= j2; --k4) {
										...
										if (d14 > -0.7D && d12 * d12 + d14 * d14 + d13 * d13 < 1.0D) {
											...
											if (block1 == Blocks.STONE || block1 == Blocks.DIRT
													|| block1 == Blocks.GRASS) {
												if (k4 < 10) {
													...
													if (flag3 && ablock[j4 - 1] == Blocks.DIRT) {
														ablock[j4 - 1] = Block.getById(this.c.getBiome(
																new BlockPosition(j3 + j * 16, 0, k3 + k * 16)).ai);
													}
												}
											}
										}
